...
const SchedulePoolTable = ({
  ...
  const { t } = useTranslation(["candidateWorkflow", "common", "interviewSchedule"]);
    ...
    <div className="card-body p-0 interview-pool">
      ...
      <div className="d-flex justify-content-between align-items-center px-3 py-3 border-bottom">
        ...
        <div className="d-flex gap-2 schddis">
          ...
          <button className="btn btn-primary fs-14" onClick={onEdit} disabled={rows.length === 0}>
            Edit Schedule
          </button>
        </div>
      </div>
                ...
                (
                  <tr key={row.id}>
                    ...
                    <td className="align-content-center">
                      ...
                      <p className="text-muted fs-12 mb-0">Application Number: {row.regNo}</p>
                  ...
                  {position?.find((p) => p.positionId === row.positionId)?.positionName || "-"}
                    ...
                    {/* Date */}
                    <td className="fs-14 align-content-center">{formatDateDDMMYYYY(row.date)}</td>
                    ...
                    <td className="text-center align-content-center">
                      ...
                      <OverlayTrigger placement="bottom" overlay={<Tooltip>View Resume</Tooltip>}>
                        <FileText className="cursor-pointer" onClick={() => onViewResume?.(row)} />
                      </OverlayTrigger>
                    </td>
                  </tr>
                )
