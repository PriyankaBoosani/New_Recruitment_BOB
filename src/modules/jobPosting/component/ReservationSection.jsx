...
const ReservationSection = ({
  ...
  //     }
  // };
  const filteredCities = cities.filter((c) => String(c.stateId) === String(currentState.state));
          ...
          <div className="d-flex gap-5 align-items-center catfonts" style={{ width: "49%" }}>
            <div>
              <h6 className="mb-0 catfont">
                {t("addPosition:category_wise_reservation")} <span className="text-danger">*</span>
              </h6>
        ...
        {!formData.enableStateDistribution ? (
          <Row className="g-4">
            <Col md={7}>
              <Card className="p-3 genfonts">
                <h6 className="text-primary mb-3">{t("addPosition:category")}</h6>
                <Row className="g-3">
                  ...
                  <Col md={2}>
                    <Form.Label className="small fw-semibold">{t("common:total")}</Form.Label>
            ...
            <Col md={5}>
              <Card className="p-3 genfonts">
                <h6 className="text-primary mb-3">{t("addPosition:disability")}</h6>
                <Row className="g-3">
                  {disabilityCategories.map((d) => (
                    <Col md={3} key={d.id}>
                      <Form.Label className="small fw-semibold">{d.disabilityCode}</Form.Label>
                      <Form.Control
          ...
          <>
            <Row className="g-3 mb-3">
              <Col md={3}>
                <Form.Label>
                  {t("addPosition:state")} <span className="text-danger">*</span>
                </Form.Label>
                <Select
              ...
              <Col md={3}>
                <Form.Label>
                  {t("addPosition:vacancies")} <span className="text-danger">*</span>
                </Form.Label>
                <Form.Control
                  type="text"
                  inputMode="numeric"
            ...
            <div className="addsubmitbtn">
              <Button className="mt-3 addstatefont" onClick={handleAddOrUpdateState}>
                {editingIndex !== null ? t("addPosition:update_state") : t("addPosition:add_state")}
              </Button>
            </div>
                ...
                <tbody>
                  {stateDistributions
                    ...
                    .map((row, idx) => (
                      <tr key={idx}>
                        <td>{idx + 1}</td>
                        <td>{states.find((s) => s.id === row.state)?.name}</td>
                        <td>
                        ...
                        {reservationCategories.map((c) => (
                          <td key={c.code}>{row.categories?.[c.code] ?? 0}</td>
                        ))}
                        <td>
                          ...
                          <Button
                            ...
                            onClick={() => {
                              setStateDistributions((prev) =>
                                prev.map((s, i) => (i === idx ? { ...s, __deleted: true } : s))
                              );
