...
const DepartmentImportView = ({ t, onClose = () => {}, onSuccess = () => {} }) => {
    ...
    <div>
      <div className="import-area p-4 rounded" style={{ background: "#fceee9" }}>
        <div className="text-center mb-3">
          ...
          <h5 className="mb-2 uploadfile">{t("department:upload_departments")}</h5>
        ...
        <div className="text-center mb-3">
          <label htmlFor="upload-xlsx">
            <Button variant="primary" as="span" className="btnupload" disabled={loading}>
              {selectedFile ? t("department:reupload_xlsx") : t("department:upload_xlsx")}
            </Button>
          </label>
