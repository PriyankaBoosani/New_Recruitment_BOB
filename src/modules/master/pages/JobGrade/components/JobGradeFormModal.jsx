          ...
          <Row className="g-3">
            <Col md={6}>
              <Form.Group>
                ...
                {isViewing ? (
                  <div className="form-control-view">{formData.scale || "-"}</div>
                ) : (
                  <Form.Control
                    name="scale"
            ...
            <Col md={6}>
              <Form.Group>
                ...
                {isViewing ? (
                  <div className="form-control-view">{formData.gradeCode || "-"}</div>
                ) : (
                  <Form.Control
                    name="gradeCode"
                    maxLength={200}
            ...
            <Col md={6}>
              <Form.Group>
                ...
                {isViewing ? (
                  <div className="form-control-view">{formatSalary(formData.minSalary) || "-"}</div>
                ) : (
                  <Form.Control
                    name="minSalary"
                    maxLength={10}
            ...
            <Col md={6}>
              <Form.Group>
                ...
                {isViewing ? (
                  <div className="form-control-view">{formatSalary(formData.maxSalary) || "-"}</div>
                ) : (
                  <Form.Control
                    name="maxSalary"
                    maxLength={10}
    ...
    <Modal show={show} onHide={onHide} size="lg" centered className="user-modal">
      <Modal.Header closeButton className="modal-header-custom">
        <div>
          ...
          {isCreateMode && <p className="mb-0 small text-muted para">{t("choose_add_method")}</p>}
        </div>
      </Modal.Header>
