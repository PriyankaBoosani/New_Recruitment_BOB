...
const SpecialCategoryImportModal = ({ onClose = () => {}, onSuccess = () => {} }) => {
    ...
    <div>
      <div className="import-area p-4 rounded" style={{ background: "#fceee9" }}>
        <div className="text-center mb-3">
          ...
          <h5 className="mb-2 uploadfile">{t("specialCategory:upload_special_categories")}</h5>

          <p className="text-muted small">{t("specialCategory:support_xlsx")}</p>
        </div>
        ...
        <div className="text-center mb-3">
          <label htmlFor="upload-xlsx-sc">
            <Button variant="primary" as="span" className="btnupload" disabled={loading}>
              {selectedFile ? t("specialCategory:reupload_xlsx") : t("specialCategory:upload_xlsx")}
            </Button>
          </label>
