...
export const useSpecialCategories = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      setCategories(mapped.sort((a, b) => new Date(b.createdDate) - new Date(a.createdDate)));
    } catch (err) {
      console.error("SpecialCategory fetch failed", err);
      setCategories([]);
      toast.error(t("specialCategory:fetch_error") || "Failed to fetch special categories");
    } finally {
      setLoading(false);
    }
  };
  ...
  const addCategory = async (payload) => {
    ...
    toast.success(t("specialCategory:add_success") || "Special category added successfully");
  };
  ...
  const updateCategory = async (id, payload) => {
    ...
    toast.success(t("specialCategory:update_success") || "Special category updated successfully");
  };
  ...
  const deleteCategory = async (id) => {
    ...
    toast.success(t("specialCategory:delete_success") || "Special category deleted successfully");
  };
