    ...
    <>
      <div className="col-md-3 col-12">
        ...
        <Select
          ...
          value={requisitionOptions.find((opt) => opt.value === selectedRequisitionId)}
      ...
      <div className="col-md-3 col-12">
        ...
        <Select
          ...
          value={positionOptions.filter((opt) => selectedPositionId?.includes(opt.value))}
          onChange={(options) => onPositionChange(options ? options.map((o) => o.value) : [])}
        />
      </div>
    </>
  );
