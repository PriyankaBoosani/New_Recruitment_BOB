...
const OfferPool = ({
  ...
  const handleCandidatePreview = async (templateId, applicationId) => {
    try {
      const res = await masterApiService.candidatePreview(templateId, applicationId);
  ...
  const fetchOffers = async () => {
    ...
    try {
      setLoading(true);
      const res = await jobPositionApiService.getOffersByPosition(selectedPositionId);
          ...
          <thead className="bg-light">
            <tr className="align-content-center">
              ...
              <th
                ...
                scope="col"
                style={{ paddingLeft: "1rem", width: "200px", minWidth: "200px" }}
              >
                {t("candidateWorkflow:candidate")}
              </th>
              <th
                className="fs-14 fw-normal py-3 border-top"
                style={{ paddingLeft: "1rem", width: "160px", minWidth: "160px" }}
                scope="col"
              >
                ...
                <tr key={c.id}>
                  ...
                  <td className="align-content-center">
                    <p
                      ...
                      style={{ paddingLeft: "0.5rem", width: "160px", minWidth: "160px" }}
                    >
                      {c.applicationNo}
                    </p>
                  </td>
                  ...
                  >
                    ...
                    <OverlayTrigger
                      placement="bottom"
                      overlay={
                        <Tooltip id={`tooltip-file-${c.id}`}>{t("common:view_file")}</Tooltip>
                      }
                    >
                      <button
                    ...
                    <OverlayTrigger
                      placement="bottom"
                      overlay={<Tooltip id={`tooltip-${c.id}`}>{t("common:view_details")}</Tooltip>}
                    >
                      <button
                        className="btn btn-sm btn-outline-secondary border-0"
                        onClick={() => {
            ...
            <div className="modal-dialog modal-xl modal-dialog-centered">
              <div className="modal-content rounded-4 border-0">
                ...
                <div className="modal-body pt-2">
                  <div
                    className="container-fluid rounded p-4 pb-1 shadow-sm"
                  ...
                  >
                    ...
                    <div className="row">
                      ...
                      />
                      <InfoField
                        label={t("candidateWorkflow:viva_mark")}
                        value={selectedOffer.vivaMarks}
                      />
                      <InfoField
                        label={t("candidateWorkflow:interview_conversion")}
                        value={selectedOffer.interviewConversion}
                      />
                    </div>
                    ...
                    <div className="row">
                      ...
                      />
                      <InfoField
                        label={t("candidateWorkflow:gd_score")}
                        value={selectedOffer.gdScore}
                      />
                      <InfoField
                        label={t("candidateWorkflow:marks_conversion_to_interview")}
                        value={selectedOffer.marksConversionToInterview}
                      />
                    </div>
