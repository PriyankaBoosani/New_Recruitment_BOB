...
//   formData.joiningBonus;
  ...
  managerForm.variablePay &&
  managerForm.joiningBonus;
...
if (responseData?.success === true) {
  ...
  toast.error(errorMsg); setShowManagerModal(false);
}
} catch (err) {
...
const canEditManagerFields =
  isUserInCompensationPanel && isRecruiter;
 ...
 return (
  ...
  {isRecruiter
    ...
    : c.panelComments || "-"}
                ...
                <td className="align-content-center">
                <span className={`round_badge px-3 py-1 fs-12 rounded ${getNegotiationClass(c.negotiation)}`}>
  {c.negotiation}
</span>
                </td>
...
<OverlayTrigger placement="bottom" overlay={<Tooltip>Compensation Details</Tooltip>}>
  <span>
   <img
  src={briefcaseIcon}
  alt="Compensation"
