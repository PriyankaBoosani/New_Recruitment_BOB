...
const candidateWorkflowServices = {
  ...
  getCandidateAllDetails: (candidateId, positionId) =>
    api.get(`/recruiter/candidate-details/get-all-details/${candidateId}/${positionId}`),
  ...
  getInterviewCandidates: (payload) => {
    return api.post("recruiter/interview-pool/get/interviewed-candidates", payload, {
      headers: {
        "X-Client": "AzureAD",
      },
    });
  ...
  getCompensationCandidates(payload) {
    return api.post("/recruiter/candidate-compensation/get-compensation-candidates", payload, {
      headers: {
        "X-Client": "recruiter",
      },
    });
  ...
  sendToCompensationPool: (payload) => {
    return api.post("/recruiter/candidate-compensation/send-to-compensation-pool", payload, {
      headers: {
        "X-Client": "recruiter",
      },
    });
  ...
  addCompensationDetails: (payload) => {
    return api.post("/recruiter/candidate-compensation/add-compensation-details", payload, {
      headers: { "X-Client": "recruiter" },
    });
  },

  getPanelScores: (scheduledInterviewId) => {
    return api.get(`/recruiter/interview-pool/get-panel-scores/${scheduledInterviewId}`, {
      headers: {
        "X-Client": "AzureAD",
      },
    });
  ...
  submitForApproval: (payload) => api.post("/recruiter/messages/submit-for-approval", payload),

  getSchedulePoolCandidates: (payload) => {
    return api.post("/recruiter/schedule-pool/get-schedule-pool-candidate-list", payload, {
      headers: {
        "X-Client": "AzureAD",
      },
    });
